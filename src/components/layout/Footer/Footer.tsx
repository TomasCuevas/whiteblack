...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-auto flex w-full items-center justify-center bg-slate-300/80 dark:bg-light/50 px-4 py-6 sm:px-6">
      <div className="flex w-full max-w-[1000px] justify-end gap-8 sm:gap-16">
        ...
        >
          ...
          <p className="text-dark dark:text-white font-inter">GitHub</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="text-dark dark:text-white font-inter">LinkedIn</p>
        </Link>
      </div>
    </footer>
  );
